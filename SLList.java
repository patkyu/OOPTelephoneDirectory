...
public class SLList implements Serializable {
    ...
    // create method to add name, address, and phone number in String form
    ...
    // create method to search through list for address addresses
    public void addressSearch(String address) {
        ...
        if (isEmpty()) {
            ...
            // if statement if no addresses match the desired search
            if (empty){
                System.out.println("No matches to that address address!");
            }
        }
